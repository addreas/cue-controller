...
type CueExportSpec struct {
	...
	// CueExport is deleted. Valid values are ('MirrorPrune', 'Delete',
...
//
// This function makes the CueExport type conformant with the meta.ObjectWithDependencies interface
