...
func NewInventory() *cuebuildv1.ResourceInventory {
	return &cuebuildv1.ResourceInventory{
		Entries: []cuebuildv1.ResourceRef{},
	}
}

// AddObjectsToInventory extracts the metadata from the given objects and adds it to the inventory.
func AddObjectsToInventory(inv *cuebuildv1.ResourceInventory, set *ssa.ChangeSet) error {
	if set == nil {
		return nil
	}

	for _, entry := range set.Entries {
		inv.Entries = append(inv.Entries, cuebuildv1.ResourceRef{
...
func ListObjectsInInventory(inv *cuebuildv1.ResourceInventory) ([]*unstructured.Unstructured, error) {
...
func ListMetaInInventory(inv *cuebuildv1.ResourceInventory) (object.ObjMetadataSet, error) {
...
func DiffInventory(inv *cuebuildv1.ResourceInventory, target *cuebuildv1.ResourceInventory) ([]*unstructured.Unstructured, error) {
	versionOf := func(i *cuebuildv1.ResourceInventory, objMetadata object.ObjMetadata) string {
