...
import (
	...
	v1 "github.com/addreas/cue-controller/api/v1"
)

func New() *v1.ResourceInventory {
	return &v1.ResourceInventory{
		Entries: []v1.ResourceRef{},
	}
}

// AddChangeSet extracts the metadata from the given objects and adds it to the inventory.
func AddChangeSet(inv *v1.ResourceInventory, set *ssa.ChangeSet) error {
	if set == nil {
		return nil
	}

	for _, entry := range set.Entries {
		inv.Entries = append(inv.Entries, v1.ResourceRef{
...
func List(inv *v1.ResourceInventory) ([]*unstructured.Unstructured, error) {
...
func ListMetadata(inv *v1.ResourceInventory) (object.ObjMetadataSet, error) {
...
func Diff(inv *v1.ResourceInventory, target *v1.ResourceInventory,
	skippedSet map[object.ObjMetadata]struct{}) ([]*unstructured.Unstructured, error) {

	versionOf := func(i *v1.ResourceInventory, objMetadata object.ObjMetadata) string {
